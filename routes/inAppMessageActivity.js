...
const configJSON = require('../activities/inAppMessage/config/config-json');
...
router.get('/:activityName/config.json', function (req, res) {
...
router.get('/:activityName/index.html', function (req, res) {
  ...
  return res.sendFile('index.html', { root: 'activities/inAppMessage/html'});
});

// setup index.html route
router.get('/:activityName/src/restActivity.js', function (req, res) {
  // you can use your favorite templating library to generate your html file.
  // this example keeps things simple and just returns a static file
  return res.sendFile('activity.js', { root: 'activities/inAppMessage/src'});
});

router.get('/:activityName/src/postmonger.js', function (req, res) {
  // you can use your favorite templating library to generate your html file.
  // this example keeps things simple and just returns a static file
  return res.redirect("/postmonger/postmonger.js")
});

router.get('/:activityName/images/icon.svg', function (req, res) {
  // you can use your favorite templating library to generate your html file.
  // this example keeps things simple and just returns a static file
...
router.get('/:activityName/images/icon.png', function (req, res) {
  // you can use your favorite templating library to generate your html file.
  // this example keeps things simple and just returns a static file
...
router.get('/:activityName/images/', function (req, res) {
  ...
  if(fs.existsSync( path + "/icon.svg")){
    ...
    return res.sendFile('icon.png', { root: 'activities/inAppMessage/images'});  
  }

});

router.get('/:activityName', function(req, res, next) {
  let name = req.params.activityName;
  res.render('restActivity', { title: 'This is the ' + name + " activity" });
});

router.post('/:activityName/save', function (req, res) {
  console.log('debug: /modules/custom-request/save');
  return res.status(200).json({});
});

router.post('/:activityName/publish', function (req, res) {
  console.log('debug: /modules/custom-request/publish');
  return res.status(200).json({});
});

router.post('/:activityName/validate', function (req, res) {
...
router.post('/:activityName/execute', function (req, res) {
